...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-[92vh] bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl w-full space-y-8">
        

        <div className="grid md:grid-cols-2 bg-white py-4 px-6 shadow-xl rounded-xl border border-gray-100">
                  <div className="px-16 items-start justify-center  mb-5">
                  <Image
                    src={logo}
                    alt="IOTechz Logo"
                    width={200}
