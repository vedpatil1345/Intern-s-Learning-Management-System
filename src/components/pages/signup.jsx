...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-[92vh] bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-7xl w-full space-y-4 ">
        
        <div className="grid md:grid-cols-2 bg-white py-4 px-6 shadow-xl rounded-xl border border-gray-100">
          <div className="px-16 items-center justify-center md:h-full mb-5 md:mb-0">
            <div>
          <Image
            src={logo}
            alt="IOTechz Logo"
          ...
          <p className="mt-2 text-lg text-gray-600">
            Join IOTechz and start your journey
          </p>
          </div>
        </div>
        <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-2.5 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
